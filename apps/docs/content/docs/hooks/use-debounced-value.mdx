...
`use-debounced-value` hook debounces value changes. This can be useful in case you want to perform a heavy operation based on react state, for example, send search request. Unlike [use-debounced-state](/docs/hooks/use-debounced-state) it is designed to work with controlled components.

<ComponentPreview name="use-debounced-value-demo" />

## Differences to useDebouncedState

This hook differs slightly from the [useDebouncedState](/docs/hooks/use-debounced-state) hook.
...
<ComponentPreview name="use-debounced-value-leading" />
...
<ComponentPreview name="use-debounced-value-cancel" />
