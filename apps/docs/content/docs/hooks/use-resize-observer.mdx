...
<ComponentPreview name="use-resize-observer-demo" />
...
See also [use-element-size](/docs/hooks/use-element-size) hook in case you need to subscribe only to `width` and `height`.
